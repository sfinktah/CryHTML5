...
#undef GetCommandLine
    ...
    bool CPluginHTML5::InitializeCEF()
    {
        ...
        DEBUG_VAR_CSTR(m_sCEFBrowserProcess.c_str());
        DEBUG_VAR_CSTR(m_sCEFLog.c_str());
        DEBUG_VAR_CSTR(m_sCEFResourceDir.c_str());
        DEBUG_VAR_CSTR(m_sCEFLocalesDir.c_str());
        ...
        bool bSuccess = CefInitialize(main_args, settings, m_app, NULL);

        OsrRenderer::Settings osrSettings;
        osrSettings.background_color = settings.background_color;
        osrSettings.transparent = true;
        osrSettings.show_update_rect = true;

        //renderer_ = new OsrRenderer(osrSettings);
...
var request_id = window.cefQuery({
    ...
    void CPluginHTML5::OnCursorChange(
        ...
        DEBUG_OUT("CPluginHTML5::OnCursorChange");
        CEF_REQUIRE_UI_THREAD();
